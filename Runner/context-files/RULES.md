...
4. **Risk-specific tests** — if touching risk/execution: test that bypass is impossible
5. **Idempotency** — if operation can be retried, test that double-execution is safe
